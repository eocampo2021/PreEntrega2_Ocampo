...
//los objetos son las compuertas.
//las funciones seran los que pueden hacer y resolver cada compuerta, sus argumentos seran las inputs del usuario.
//otras funciones axuliares comprueban que las inputs sean validos.
...
if(tipoCompuerta == 1){
	const compuertaAND = new Compuerta("Compuerta tipo AND", inputs[0],inputs[1]);
